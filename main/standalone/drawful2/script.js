...
const jx = Et.View.extend({
    ...
    <div id="game" class="game pt-pageholder">    
        ...
        <div class="pt-page-off state-liereceived drawful2-page">
            <div class="container">
                <br /><span class='drawful-text'>¡título enviado!<br />esperando a otros jugadores.</span><br />
            </div>
        </div>
